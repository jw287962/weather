...
.then(() => {
  console.log(promise);
  (0,_updateHTML__WEBPACK_IMPORTED_MODULE_2__.updateWeatherHTML)();
})
.catch((err) => {
  console.log('ERR:', err);
});
