...
function importAll(r) {
 ...
 const images = importAll(__webpack_require__("./src/asset/images sync \\.(png%7Cjpe?g%7Csvg)$"));
...
if(!hasEntered){
  ...
  let promise =  (0,_weather__WEBPACK_IMPORTED_MODULE_0__.fetchWeatherCurrent)(data);
...
function getDate(element,num){
  ...
  const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(addNum,'iiiiii');
return date;
...
function getSunset(data) {
  const timeOfSunset = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sys.sunset);
...
function getSunrise(data) {
  const timeOfSunrise = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sys.sunrise);
...
function formatTime(data){
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(data), 'pp');
}
...
let promise = (0,_weather__WEBPACK_IMPORTED_MODULE_1__.fetchWeatherCurrent)(defaultLocation);
let promiseForcast = (0,_weather__WEBPACK_IMPORTED_MODULE_1__.fetchWeatherForecast)(defaultLocation);

(0,_updateHTML__WEBPACK_IMPORTED_MODULE_2__.promiseEvalUpdateHTML)(promise,defaultLocation);
